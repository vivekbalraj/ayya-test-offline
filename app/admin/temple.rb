ActiveAdmin.register Temple do
  ...
  permit_params :name, :temple_type, :information, :village, :latitude, :longitude, :district, :founded_at, :running_generation
